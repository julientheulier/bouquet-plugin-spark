 ...
 */
public class  SparkTruncateOperatorRenderer 
extends BaseOperatorRenderer
{
	static final Logger logger = LoggerFactory.getLogger(SparkTruncateOperatorRenderer.class);
	
	public  SparkTruncateOperatorRenderer() {
	}
