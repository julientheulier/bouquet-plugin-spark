 ...
 * Sinh(x) function
 */
public class SparkSinhOperatorRenderer extends BaseOperatorRenderer {
	static final Logger logger = LoggerFactory.getLogger(SparkSinhOperatorRenderer.class);
	
	public SparkSinhOperatorRenderer() {
	}
