 ...
 * Random function
 */
public class  SparkRandOperatorRenderer 
extends BaseOperatorRenderer
{
	static final Logger logger = LoggerFactory.getLogger(SparkRandOperatorRenderer.class);
	
	public  SparkRandOperatorRenderer() {
	}
